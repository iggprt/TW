...
# f?÷rom gi.repository import Gtk, Gdk
from button import MyCustomToolbar
...
print (fig.canvas.manager.toolbar.__dict__.keys())
# Add the custom tools that we created

fig.canvas.manager.toolbar(MyCustomToolbar)

# fig.canvas.manager.toolbar.add_tool('List', ListTools)
# fig.canvas.manager.toolbar.add_tool('Hide', GroupHideTool, gid='mygroup')
